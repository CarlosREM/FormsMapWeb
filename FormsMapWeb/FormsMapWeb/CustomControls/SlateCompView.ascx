<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SlateCompView.ascx.cs" Inherits="FormsMapWeb.CustomControls.SlateCompView" %>
...
<asp:Panel ID="MainPanel" runat="server" Width="800px" CssClass="question" Direction="LeftToRight" HorizontalAlign="Left">
    <table>
    <tr><td>
    <asp:Panel ID="QuestionPanel" runat="server" Width="480px">
