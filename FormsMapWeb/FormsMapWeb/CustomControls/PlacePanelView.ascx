...
<asp:Panel ID="MainPanel" runat="server" BorderColor="#FFC367" BorderStyle="Solid" CssClass="panel" Width="720px">
    ...
    <asp:Button ID="btnEditar" runat="server" BorderStyle="None" Font-Bold="False" Font-Names="Lato" Text="Editar" OnClick="btnEditar_Click" CssClass="button"/>
    ...
    <asp:Panel ID="InfoPanel" runat="server" CssClass="infopanel">
        ...
        &nbsp;
        <asp:Label ID="lblInfoField" BorderStyle="None" runat="server" Font-Bold="False" Font-Names="Lato" Text="innnnformacion"></asp:Label>
    </asp:Panel>
</asp:Panel>